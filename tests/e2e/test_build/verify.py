...
dockerActualTestFiles = [file for file in os.listdir("./bin/generation/docker/student_tests/") if os.path.isfile(os.path.join("./bin/generation/docker/student_tests/", file))]
...
assert not os.path.exists("./bin/generation/docker/starter_code/")
...
docker_actual_directories = os.listdir("./bin/generation/docker/student_tests/data/files/")
...
docker_actual_public_files = os.listdir("./bin/generation/docker/student_tests/data/files/test_public")
docker_actual_public_files.sort()

docker_actual_private_files = os.listdir("./bin/generation/docker/student_tests/data/files/test_private")
